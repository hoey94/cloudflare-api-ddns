...
CFKEY=b0eecbd516c57637060d89e4a7d1956a1c9a1 #
 #';.'
# Username, your email address,eg: user@example.com #
CFUSER=646660803@qq.com #
 #
# Zone name,your domain name, eg: example.com #    
CFZONE_NAME=hoey.top #
 #
# Hostname to update, eg: homeserver.example.com #
CFRECORD_NAME=dip.hoey.top #
 #
##################################################################################################################################
...
WAN_IP=`curl http://members.3322.org/dyndns/getip`
...
--data "{\"type\":\"$CFRECORD_TYPE\",\"name\":\"$CFRECORD_NAME\",\"content\":\"$WAN_IP\", \"ttl\":$CFTTL,\"proxied\": true}")
